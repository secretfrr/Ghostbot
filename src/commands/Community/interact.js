...
const profileschema = require('../../schemas/interaction');
    ...
    async execute(interaction) {
        ...
        switch (sub) {
            ...
            if (interaction.user.id === displayuser.id) {
                ...
                await interaction.reply({ content: `You tried **giving yourself** a **hug**, it **didn't** work dumbass💔`, ephemeral: true});
