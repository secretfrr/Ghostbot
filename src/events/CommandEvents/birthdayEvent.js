...
module.exports = async (client) => {
  setInterval(async () => {
    ...
    const channel = client.channels.cache.get('1307963088162525255'); // Replace CHANNEL_ID with the actual ID of the channel

    if (!channel) {
      console.error(`Error: could not find channel ${channel}`);
      return;
    }
