...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (!docs) return;
        const errorEmbed = new EmbedBuilder().setColor('Red').setDescription(client.config.ticketError);
        ...
        const nopermissionsEmbed = new EmbedBuilder().setColor('Red').setDescription(client.config.ticketNoPermissions);
        ...
        switch (customId) {
            case 'ticket-close':
                ...
                const closingTicket = new EmbedBuilder().setTitle(client.config.ticketCloseTitle).setDescription(client.config.ticketCloseDescription).setColor('Red')
