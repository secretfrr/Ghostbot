...
module.exports = {
    ...
    async execute(message, client) {
        ...
        .setAuthor({ name: `Bot Information`, iconURL: client.user.displayAvatarURL({ dynamic: true }) })
        .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))
        .setFooter({ text: `Most up-to-date information about ${client.user.username}`})
        .setTimestamp()
        .addFields({ name: 'Developer', value: `<@375931932036431873>` })
            .addFields({ name: 'Support Server:', value: `> [Click here](https://discord.gg/tYvw4RHC8w)`})
